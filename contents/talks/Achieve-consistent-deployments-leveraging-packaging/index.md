...
.remark-slide-content { background-color:#070707; background-repeat:no-repeat; }
.footnote { bottom: 12px; position:absolute; left:20px; }
.remark-slide li+li { margin-top:5%; }
.remark-slide li, .remark-slide p { font-size:1.4em; }
...
.remark-slide .footnote { background-color:rgba(255, 255, 255, 0.6); padding:10px; }
.remark-slide .mozilla-branded { color:#5C5353; background:#EAEFF2 url("images/mdn-header-background.png") repeat; }
.remark-slide .webplatform-components { background-size:100%; padding:0 !important; }
.remark-slide .webplatform-components h1 { background-color:rgba(255, 255, 255, 0.8); padding:10px 0; }
